...
slidingWindows = 1:10;
qualityMeasures = {'psnr', 'ssim', 'msssim', 'ifc', 's3', 'brisque', 'sseq', 'niqe', 'srm'};
...
slidingWindows = 1;
compression = {'Uncoded'};
qualityMeasures = {'psnr', 'ssim', 'msssim', 'ifc'};

% Get SR results with quality measures.
srResults_simulated = getQualityMeasuresFromResults([resultDir '/simulatedDatasets'], {}, {'global_pan_translation_xyz_inlier'}, compression, binningFactors, 1:length(SRMethods), numberOfFrames, slidingWindows, 1:4);
srResults_real = getQualityMeasuresFromResults([resultDir '/baselineDatasets'], {}, {'global_pan_translation_xyz_inlier'}, compression, binningFactors, 1:length(SRMethods), numberOfFrames, slidingWindows, 1:4);
